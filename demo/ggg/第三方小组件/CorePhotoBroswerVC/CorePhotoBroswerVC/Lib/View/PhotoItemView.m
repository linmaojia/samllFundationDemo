...
- (void)swipeGestureAction:(UISwipeGestureRecognizer*)swipeGesture
{
    ...
    {
        if ([self.currentColor isEqualToString:@"W"])
        {
            self.photoImageView.backgroundColor = [UIColor blackColor];
            self.currentColor = @"B";
            
        }else if ([self.currentColor isEqualToString:@"G"])
        {
...
{
    if (_leftSwipeGesture == nil)
    {
        _leftSwipeGesture = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(swipeGestureAction:)];
...
{
    if (_rightSwipeGesture == nil)
    {
        _rightSwipeGesture = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(swipeGestureAction:)];
